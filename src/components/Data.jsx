  ...
  somePresents: [
    {
      ...
      text: "В пластиковой упаковкесамый бюджетный вариант",
      price: "от 150 руб/шт",
    },
    {
      img: macaronsSeal9,
      ...
      text: "С логотипом Вашей копании, пожеланиями и т.д.",
      price: "от 500 руб",
    },
    {
      img: round40,
      ...
      text: "Для самых любимых и дорогих клиентов",
      price: "от 3600 руб",
    },
    {
      img: set70,
      ...
      text: "Роскошный подарок для большой компании",
      price: "от 5600 руб",
    },
  ],
  completedOrdets: [
    {
      img: heart,
      alt: "heart set",
      title: "Макароны для отеля “Бла бла”",
    },
    {
      img: heart,
      alt: "heart set",
      title: "Набор для кафе “Мята”",
    },
    {
      img: heart,
      alt: "heart set",
  ...
  answers: [
    {
      ...
      text: "Срок хранения бла бла бла",
    },
    {
      title: "Как быстро мы выполняем заказы",
      text: "Стандартный срок выполнения заказа 3-5 дней, При большом тираже и в предновогодний сезон может увеличиться. Потому что...",
    },
    {
      title: "А за 2 дня?",
      text: "Текст про дополнительную стоимость при срочных заказах",
    },
    {
      title: "А с НДС работаете?",
      text: "Для вашего удобства у нас есть два варианта взаимодействия: с НДС и без НДС. Всегда уточняйте форму оплаты у менеджера, чтобы получить максимально выгодные для вас условия!",
    },
    {
      title: "Что с доставкой?",
      text: "Мы доставляем ваши заказы по всей России: от Камчатки до Калининграда, бережно упаковывая каждую печеньку или набор. Мы всегда производим для вас на 2-5% больше от заказанного количества, чтобы ничего не смогло омрачить результат нашей работы. Сроки доставки 2-7 дней с момента заказа.",
    },
    {
      title: "Ещё вопрос",
