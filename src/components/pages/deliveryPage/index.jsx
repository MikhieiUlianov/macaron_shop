          ...
          <div className="delivery__wrapper-block delivery__wrapper-first">
            ...
            <div className="delivery__section">
              ...
              <div className="delivery__description">
                ...
                <p>Если Вы готовы принять заказ в интервале с 12 до 17 часов</p>
                <p>или с 17 до 21 часа, то доставка будет стоить 300 рублей.</p>
                <p>
                  При заказе от 3000 рублей доставка <strong>БЕСПЛАТНАЯ</strong>
                  .
                </p>
                <p>
            ...
            <div className="delivery__text-block">
              ...
              <div className="delivery__description">
                <p>
                  ...
                  производства по адресу: ул. Маршала Тухачевского 22, БЦ
                  "Сова".
                </p>
                <p>
